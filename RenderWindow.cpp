...
//
//  Also, by providing olample code, the didactic purpose of
...
RenderWindow::RenderWindow
    ...
    showGamma                   = new QCheckBox                 ("Gamma Correct",       this);
    ...
    windowLayout->addWidget(showGamma,                  14,         3,          1,          1           );
...
void RenderWindow::ResetInterface()
    ...
    showGamma               ->setChecked        (renderParameters   ->  showGamma);
