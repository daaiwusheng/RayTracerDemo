...
class RaytraceRenderWidget : public QOpenGLWidget										
    ...
    std::shared_ptr<RGBAImage> frameBuffer;

    std::shared_ptr<ray::Raytracer> raytracer;

    std::deque<std::shared_ptr<RGBAImage>> frames;
