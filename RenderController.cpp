...
RenderController::RenderController
    ...
    QObject::connect(   renderWindow->showGamma,                  SIGNAL(stateChanged(int)),
                        this,                                       SLOT(showGammaCheckChanged(int)));
...
void RenderController::showGammaCheckChanged(int state)
    { // RenderController::showAxesCheckChanged()
    // reset the model's flag
    renderParameters->showGamma = (state == Qt::Checked);
